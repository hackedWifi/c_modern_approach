 ...
 *
 *    Description:  Modify the inventory2.c program of Section 17.5 by adding an e 
 *                  (erase) command that allows the user to remove a part from the data-
 *                  base.
 *
 *        Version:  1.0
 *        Created:  05/10/2021 03:48:48 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
...
int main ( int argc, char *argv[] )
{
  ...
  for ( ; ; ) {
    printf ( "Enter operation code i (insert), e (erase), s (search)," 
